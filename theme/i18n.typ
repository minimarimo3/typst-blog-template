...
#let _translations = (
  ja: (
    ...
    abstract: "概要",
    footnotes: "脚注",
    back_to_footnote_reference: "本文の脚注参照に戻る",
    code: "コード",
    search: "検索",
    ...
    article_actions: "記事へのアクション",
    adjacent_articles: "前後の記事",
    writing_env: "執筆環境",
    env_software: "ソフト名",
    env_version: "バージョン",
    env_notes: "補足",
  ...
  en: (
    ...
    abstract: "Abstract",
    footnotes: "Footnotes",
    back_to_footnote_reference: "Back to footnote reference",
    code: "Code",
    search: "Search",
    ...
    adjacent_articles: "Previous and next articles",
  ...
  ko: (
    ...
    abstract: "개요",
    footnotes: "각주",
    back_to_footnote_reference: "본문의 각주 참조로 돌아가기",
    code: "코드",
    search: "검색",
    ...
    article_actions: "글 작업",
    adjacent_articles: "이전 글과 다음 글",
    writing_env: "작성 환경",
    env_software: "소프트웨어",
    env_version: "버전",
    env_notes: "비고",
  ...
  "zh-CN": (
    ...
    abstract: "摘要",
    footnotes: "脚注",
    back_to_footnote_reference: "返回正文脚注引用",
    code: "代码",
    search: "搜索",
  ...
  "zh-TW": (
    ...
    abstract: "摘要",
    footnotes: "註腳",
    back_to_footnote_reference: "返回正文註腳引用",
    code: "程式碼",
    search: "搜尋",
